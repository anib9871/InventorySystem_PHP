  ...
  <ul class="submenu" style="display:block !important;">
    ...
    <li>
      ...
      <ul class="submenu">
        ...
        <?php if(in_array('proforma', $sub_perms) || in_array('duplicate_print', $sub_perms)): ?><li><a href="proforma_list.php">Proforma Invoice</a></li><?php endif; ?>
    ...
    <li>
      ...
      <ul class="submenu">
        <?php if(in_array('supp_advance', $sub_perms)): ?><li><a href="supplier_advance.php">Supplier Advance</a></li><?php endif; ?>
         ...
         <?php if(in_array('payment_report', $sub_perms)): ?><li><a href="payment_report.php">Payment Report</a></li><?php endif; ?>
